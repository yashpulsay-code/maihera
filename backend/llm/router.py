...
OLLAMA_MODELS = {
    ...
    'dream_synthesis':    'deepseek-v3.1:671b-cloud',
...
GROQ_MODELS = {
    ...
    'dream_synthesis':    'llama-3.3-70b-versatile',
...
GEMINI_FLASH_MODELS = {
    ...
    'dream_synthesis':    'gemini-2.0-flash-lite',
...
ROUTING_TABLE = {
    ...
    'dream_synthesis':    ['ollama', 'gemini_flash', 'groq', 'gemini_flash_lite'],
